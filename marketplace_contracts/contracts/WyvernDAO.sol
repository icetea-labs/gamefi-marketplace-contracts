...
contract WyvernDAO is DelegatedShareholderAssociation {
    ...
    uint public constant REQUIRED_SHARES_TO_BE_BOARD_MEMBER = 0 * (10 ** TOKEN_DECIMALS); // set to ~ 0.1% of supply
    uint public constant MINIMUM_QUORUM                     = 0 * (10 ** TOKEN_DECIMALS); // set to 10% of supply
